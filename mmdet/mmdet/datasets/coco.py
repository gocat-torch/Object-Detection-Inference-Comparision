...
@DATASETS.register_module
class VOC_CocoDataset(CustomDataset):

    CLASSES = ('cow','chair','bus','dog','person','pottedplant','car','boat','cat','bicycle','train',
            'bottle','sofa','horse','aeroplane','diningtable','bird','motorbike','tvmonitor','sheep')
...
@DATASETS.register_module()
class _VOC_CocoDataset_(CustomDataset):
